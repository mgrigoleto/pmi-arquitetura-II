void play_non_blocking_scenario() {
  ...
  if (rank == 0) {
    ...
    MPI_Isend(buffer, buffer_count, MPI_INT, 1, 99, MPI_COMM_WORLD, &request);
    ...
    MPI_Isend(buffer, buffer_count, MPI_INT, 1, 100, MPI_COMM_WORLD, &request);
    ...
    MPI_Irecv(buffer, buffer_count, MPI_INT, 0, 99, MPI_COMM_WORLD, &request);
    ...
    MPI_Irecv(buffer, buffer_count, MPI_INT, 0, 100, MPI_COMM_WORLD, &request);
